...
function getPreferredPorts() {
  return {
    webapp: readPort("UMLSTUDIO_WEBAPP_PORT", DEFAULT_PORTS.webapp),
...
async function main() {
  ...
  const children = [
    spawnManagedProcess({
      name: "lib",
      command: commandBinary("packages/core", "tsc"),
      args: ["-b", "--watch"],
    ...
    spawnManagedProcess({
      name: "lib",
      command: commandBinary("packages/core", "vite"),
      args: ["build", "--watch"],
      cwd: path.join(repoRoot, "packages/core"),
      env: coloredEnv,
    }),
    spawnManagedProcess({
      name: "server",
      command: commandBinary("apps/server", "tsx"),
    ...
    spawnManagedProcess({
      name: "webapp",
      command: commandBinary("apps/webapp", "vite"),
      args: [],
