      ...
      <div className="space-y-6">
        ...
        >
          {cards.map((index) => (
            <div
              key={index}
              className="home-diagram-card flex min-h-[var(--card-min-h)] w-full flex-col overflow-hidden rounded-[var(--umlstudio-chrome-radius-lg)] border border-[var(--umlstudio-chrome-border)] bg-[var(--home-card-surface)] shadow-[var(--umlstudio-chrome-shadow-floating)]"
            >
