...
import { DropdownMenu, DropdownMenuContent } from "@umlstudio/ui/components/dropdown-menu"
...
describe("VisionPhotoImportItem", () => {
  it("renders the photo import entry in the Import group", () => {
    renderItem({})
    expect(screen.getByRole("menuitem", { name: /importar desde imagen/i })).toBeTruthy()
  })
  ...
  it("opens the vision flow and closes the menu on click", () => {
    ...
    fireEvent.click(screen.getByRole("menuitem", { name: /importar desde imagen/i }))
