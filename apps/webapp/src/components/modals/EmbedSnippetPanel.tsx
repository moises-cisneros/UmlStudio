...
import { Tabs, TabsList, TabsTrigger } from "@umlstudio/ui/components/tabs";
...
const FORMAT_HINTS: Record<EmbedFormat, string> = {
  markdown: "A clickable, auto-updating card — opens the diagram in UmlStudio.",
        ...
        <>
          ...
          <div className="flex items-stretch">
            <input
              ...
              className="h-9 min-w-0 grow rounded-l-md border border-r-0 border-[var(--home-border-default)] bg-[var(--umlstudio-background)] px-3 font-mono text-xs text-foreground outline-none"
            />
            <Button
