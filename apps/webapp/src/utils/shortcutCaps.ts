...
export const formatCombo = (combo: UmlStudioShortcutCombo, caps: Keycaps): string[] => {
...
export const formatComboText = (combo: UmlStudioShortcutCombo, caps: Keycaps = keycaps()): string =>
  formatCombo(combo, caps).join(caps.isMac ? "" : "+")
