  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        methods: [
          { id: "p-m1", name: "+ calcularTotal(): Double" },
        ],
      },
...
describe("INT-CU06: Spring Boot Code Generation & Initializr Pipeline", () => {
  ...
  it("POST /api/generate produces a complete compilable Spring Boot ZIP with 5 layers and port 9000", async () => {
    ...
    expect(ymlContent).toContain("jdbc:postgresql://localhost:5432/ventas_db");
    ...
    expect(clienteRepo).toContain("public interface ClienteRepository extends JpaRepository<Cliente, Long>");
