...
export const getNodeConnectionRect = (nodeType: string | undefined, rect: Rect): Rect => {
...
export const getRoutingPositionOnCanvas = (
  ...
  let parent = node.parentId ? allNodes.find((candidate) => candidate.id === node.parentId) : null
...
const ROUTING_PARENT_NODE_TYPES = new Set(["package"])
