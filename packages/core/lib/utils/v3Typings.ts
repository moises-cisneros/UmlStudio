...
export type ObjectNodeProps = any
export type CommunicationObjectNodeProps = any
export type ComponentNodeProps = any
export type ComponentSubsystemNodeProps = any
export type DeploymentNodeProps = any
export type DeploymentComponentProps = any
export type PetriNetPlaceProps = any
export type BPMNTaskProps = any
