  ...
  return (
    <div
      style={{
        ...
        top: 10,
        right: 10,
        background: "var(--umlstudio-chrome-glass)",
        border: "1px solid var(--umlstudio-chrome-border)",
        borderRadius: "var(--umlstudio-radius-sm, 4px)",
        padding: "10px",
        fontSize: "12px",
    ...
    >
      ...
      {selectedElementIds.length > 0 ? (
          ...
          {Array.from(selectedElementIds).map((id) => {
            ...
            return (
              <div
                key={id}
                style={{
                  border: "2px solid var(--umlstudio-grid)",
                  padding: "4px",
                }}
              >
                <div>
        ...
        <div
          style={{
            fontStyle: "italic",
            color: "var(--umlstudio-chrome-text-muted)",
          }}
        >
